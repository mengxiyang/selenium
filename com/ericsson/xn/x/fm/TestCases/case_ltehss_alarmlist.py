...
getalarmlist_mapping_cfg_new = root_dir + os.sep + 'x' + os.sep + 'fm' + os.sep + 'nbi_mapping' + os.sep + 'hss_get_alarm_list_new_alarm.cfg'
getalarmlist_mapping_cfg_clear = root_dir + os.sep + 'x' + os.sep + 'fm' + os.sep + 'nbi_mapping' + os.sep + 'hss_get_alarm_list_clear_alarm.cfg'
getalarmlist_mapping_cfg_change = root_dir + os.sep + 'x' + os.sep + 'fm' + os.sep + 'nbi_mapping' + os.sep + 'hss_get_alarm_list_change_alarm.cfg'
...
def check_ltehss_get_alarmlist_accuracy():
    pre_test_case("check_ltehss_get_alarmlist_case","nbi_get_alarm_list")
    check_alarm_list_accuracy(ne_info_cfg,server_info_cfg,getalarmlist_mapping_cfg_new)
    #getlarmlist remove the display of clearalarm
