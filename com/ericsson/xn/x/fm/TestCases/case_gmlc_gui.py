...
ne_info_cfg = root_dir + "x" + os.sep + "pm" + os.sep + "nes" + os.sep + "gmlc.cfg"
alarm_mapping_cfg = root_dir + "x" + os.sep + "fm" + os.sep + "gui_mapping" + os.sep + "gmlc.cfg"

def check_gmlc_alarm_accuracy():
    pre_test_case("check_gmlc_gui_accuracy_case","gui_fm_accuracy")
