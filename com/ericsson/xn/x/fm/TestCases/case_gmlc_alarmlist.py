...
getalarmlist_mapping_cfg_new = root_dir + os.sep + 'x' + os.sep + 'fm' + os.sep + 'nbi_mapping' + os.sep + 'gmlc_get_alarm_list_new_alarm.cfg'
getalarmlist_mapping_cfg_clear = root_dir + os.sep + 'x' + os.sep + 'fm' + os.sep + 'nbi_mapping' + os.sep + 'gmlc_get_alarm_list_clear_alarm.cfg'
...
def check_gmlc_get_alarmlist_accuracy():
    pre_test_case("check_gmlc_get_alarmlist_case","nbi_get_alarm_list")
