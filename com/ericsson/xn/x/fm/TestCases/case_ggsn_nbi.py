...
ne_info_cfg = root_dir + os.sep + 'x' + os.sep + 'pm' + os.sep + 'nes' + os.sep + 'ggsn.cfg'


def check_nbi_accuracy():
    pre_test_case("check_ggsn_nbi_accuracy_case","nbi_notify_accuracy")
