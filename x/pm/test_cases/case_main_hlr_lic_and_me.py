...
ne_info_cfg = os.path.normpath(root_dir + sep + 'x' + sep + 'pm' + sep + 'nes' + sep + 'hlr.cfg')
counter_info_cfg = os.path.normpath(root_dir + sep + 'x' + sep + 'pm' + sep + 'counters' + sep + 'hlr.cfg')
me_counter_cfg = os.path.normpath(root_dir + sep + 'x' + sep + 'pm' + sep + 'me_counters' + sep + 'hlr.cfg')
me_types_cfg = os.path.normpath(root_dir + sep + 'x' + sep + 'pm' + sep + 'counter_types' + sep + 'hlr.cfg')
