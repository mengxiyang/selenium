...
me_types_cfg = os.path.normpath(root_dir + sep + 'x' + sep + 'pm' + sep + 'counter_types' + sep + 'sgw.cfg')
me_counter_cfg = os.path.normpath(root_dir + sep + 'x' + sep + 'pm' + sep + 'me_counters' + sep + 'sgw.cfg')
t_now = datetime.now()
