...
ne_info_cfg = os.path.normpath(root_dir + sep + 'x' + sep + 'pm' + sep + 'nes' + sep + 'msc.cfg')
counter_info_cfg = os.path.normpath(root_dir + sep + 'x' + sep + 'pm' + sep + 'counters' + sep + 'msc.cfg')
me_counter_cfg = os.path.normpath(root_dir + sep + 'x' + sep + 'pm' + sep + 'me_counters' + sep + 'msc.cfg')
me_types_cfg = os.path.normpath(root_dir + sep + 'x' + sep + 'pm' + sep + 'counter_types' + sep + 'msc.cfg')
