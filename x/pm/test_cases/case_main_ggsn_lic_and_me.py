...
ne_info_cfg = os.path.normpath(root_dir + sep + 'x' + sep + 'pm' + sep + 'nes' + sep + 'ggsn.cfg')
counter_info_cfg = os.path.normpath(root_dir + sep + 'x' + sep + 'pm' + sep + 'counters' + sep + 'ggsn.cfg')
me_counter_cfg = os.path.normpath(root_dir + sep + 'x' + sep + 'pm' + sep + 'me_counters' + sep + 'ggsn.cfg')
me_types_cfg = os.path.normpath(root_dir + sep + 'x' + sep + 'pm' + sep + 'counter_types' + sep + 'ggsn.cfg')
